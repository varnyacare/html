...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const datePrint = document.getElementById("invoiceDatePrint");

    if (!dateInput || !datePrint) return;
    ...
    // Set default date
    datePrint.innerText = formatDate(dateInput.value);

    // Update when user changes date
    dateInput.addEventListener("change", function () {
        datePrint.innerText = formatDate(this.value);
    });
