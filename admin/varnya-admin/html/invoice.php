    ...
    <div style="width:100%; display:flex;">
      <div style="width:500px">
        <table class="hm-p table-bordered" style="width: 100%; margin-top: 30px">
          ...
          <tr>
            <th style="vertical-align: top; width:150px" id="gstLabel">GST 5%</th>
            <td style="vertical-align: top; color: #000; width:130px">
              <b class="fgst"> </b>
            </td>
          </tr>
          <tr>
            <th style="vertical-align: top; width:150px" id="cGSTLabel">CGST 2.5%</th>
          ...
          <tr>
            <th style="vertical-align: top; width:150px" id="sGSTLabel">SGST 2.5%</th>
            <td style="vertical-align: top; color: #000; width:130px">
              <b class="sgst"></b>
            </td>
          </tr>
                  ...
                  <table class="table table-bordered">
                    <thead class="table-success">
                      <tr>
                        ...
                        <th scope="col" class="text-end stylist" style="width:25%">Stylist</th>
                        <th scope="col" class="NoPrint">                         
                            <button id="addProductBtn" type="button" class="btn btn-sm btn-success" onclick="BtnAddProduct()" disabled>+</button>
                        </th>
                      </tr>
                    </thead>
