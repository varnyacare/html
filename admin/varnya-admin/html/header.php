      ...
      >
        ...
        <ul class="navbar-nav float-start me-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu create-new" aria-labelledby="navbarDropdown">
        ...
        <ul id="sidebarnav" class="pt-4">
          ...
          <li class="sidebar-item">
            <a
              ...
              aria-expanded="false"
              ><i class="mdi-view-list mdi" aria-hidden="true"></i><span class="hide-menu">Invoice list</span></a
            >
          </li>
          ...
          <li class="sidebar-item">
            <a
              ...
              ><span class="hide-menu">Sales History</span></a
            >
          </li>
          <li class="sidebar-item">
            <a
          ...
          <li class="sidebar-item">
            <a
              ...
              aria-expanded="false"
              ><i class="mdi mdi-account"></i
              ><span class="hide-menu">Stylist</span></a
            >
          </li>
          <!-- <li class="sidebar-item">
            <a
              ...
              ><span class="hide-menu">Salon location</span></a
            >
          </li> -->
          <!-- <li class="sidebar-item">
            <a
              class="sidebar-link waves-effect waves-dark sidebar-link"
              href="salon-manager.php"
              aria-expanded="false"
              ><i class="mdi mdi-chart-bubble"></i
              ><span class="hide-menu">Salon Manager</span></a
            >
          </li> -->
          <!-- <li class="sidebar-item">
            <a
              ...
              href="sale.php"
              aria-expanded="false"
              ><i class="fa fa-cart-arrow-down" aria-hidden="true"></i><span class="hide-menu">Quick Sale</span></a
            >
          </li> -->
