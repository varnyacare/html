...
<html dir="ltr">
  ...
  <body>
    <div class="main-wrapper spinner-container">
        ...
        <div class="auth-box bg-dark border-top border-secondary">
          <div id="loginform">
            <div class="text-center pt-3 pb-3">
              <span class="db"
                ><img src="../assets/images/logo-text.png" alt="logo" style="margin-bottom: -40px;"
              /></span>
            </div>
            <!-- Form -->
            <form
    ...
    <script src="../dist/api/login.js"></script>
  </body>
</html>
