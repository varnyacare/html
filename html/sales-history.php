  ...
  <body>
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="row">
            <div class="col-3">
                <span class="mdi mdi-account">Select stylist</span>
                <select class="form-select" id="stylist">
            ...
            <div class="col-3">
                <br>
                <button class="btn btn-success" type="button" id="filter" onclick="FilterSalesData()">Filter</button>
            </div>
        </div>
        <br>
          ...
          <div class="row">
            <div class="col-4">
                ...
                <h5 class="mb-0 mt-1" id="total-booking">0</h5>
                <small class="font-light">Total Booking</small>
                </div>
            </div>
            <div class="col-4">
                <div class="bg-dark p-10 text-white text-center">
            ...
            <div class="col-4">
                <div class="bg-dark p-10 text-white text-center">
                <i class="far fa-hand-scissors fs-3 mb-1 font-16"></i>
                <h5 class="mb-0 mt-1" id="total-services">0</h5>
                <small class="font-light">Total Services Booked</small>
                </div>
            </div>
            <!-- <div class="col-2">
                <div class="bg-dark p-10 text-white text-center">
    ...
    <script src="../dist/api/sales-history.js"></script>
